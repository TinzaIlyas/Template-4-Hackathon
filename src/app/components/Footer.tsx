...
export default function Footer (){
  return (
<div className="bg-gray-300 py-8 font-[sans-serif]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        </div>
        ...
        <div className="grid grid-cols-4 gap-8">
          <div className="col-span-1">
            ...
            <p className="text-gray-750">
              ...
              <button className="bg-pink-500 hover:bg-pink-800 text-white px-1 py-2 rounded ml-2">Sign Up</button>
            </p>
